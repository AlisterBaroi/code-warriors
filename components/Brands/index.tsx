...
const brandsData: Brand[] = [
  {
    id: 1,
    name: "Abdullah",
    href: "https://github.com/Abdallah-69",
  ...
  },
  {
    id: 3,
    name: "Danish",
    href: "https://github.com/Danishlynx",
  ...
  },
  {
    id: 4,
    name: "Hamza",
    href: "https://github.com/ihamzazam",
  ...
  },
  {
    id: 5,
    name: "Hassan",
    href: "https://github.com/muhammadhassanmajeed",
      ...
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <h1 className="text-center text-5xl mb-5">Our Team</h1>
            <div
